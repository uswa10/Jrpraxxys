                ...
                <div class="card-body">
                    ...
                    <div class="well">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div style='float: right;'>{!!Form::open(['action'=>['App\Http\Controllers\PostController@destroy', $posts->id], 'method'=>'POST', 'class' => 'pull-right'])!!} {{Form::hidden('_method','DELETE')}} {{Form::submit('Delete', ['class' => 'btn btn-danger'])}}
                                    {!!Form::close()!!}    </div>
                                <div class="panel-heading"> <h4>{{$posts->name}}</h4></div>
                                 ...
                                 <div class="panel-body">
                                   ...
                                   {{Form::submit('Like', ['class' => 'btn btn-like'])}}
                                     @else
                                   {{Form::submit('You liked this', ['class' => 'btn btn-like'])}}
                                     @endif
